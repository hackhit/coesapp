class TipoasignaturasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipoasignatura.save
        format.html { redirect_to @tipoasignatura, notice: 'Tipoasignatura was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipoasignatura.update(tipoasignatura_params)
        format.html { redirect_to @tipoasignatura, notice: 'Tipoasignatura was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tipoasignaturas_url, notice: 'Tipoasignatura was successfully destroyed.' }
